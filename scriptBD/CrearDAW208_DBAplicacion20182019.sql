-- Crear base de datos --
	CREATE DATABASE if NOT EXISTS DAW208_DBAplicacion20182019
;
-- Crear del usuario --
	CREATE USER IF NOT EXISTS 'DAW208Aplicacion20182019'@'%' identified BY 'paso'; 
...
-- Dar permisos al usuario --
	GRANT ALL PRIVILEGES ON DAW208_DBAplicacion20182019.* TO 'DAW208Aplicacion20182019'@'%'; 
